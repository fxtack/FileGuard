...
VOID
NtFreezerOperationStatusCallback (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
...
BOOLEAN
NtFreezerDoRequestOperationStatus(
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerInstanceSetup: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerInstanceQueryTeardown: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerInstanceTeardownStart: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerInstanceTeardownComplete: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerUnload: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerPreOperation: Entered\n") );
    ...
    if (NtFreezerDoRequestOperationStatus( Data )) {
        ...
        if (!NT_SUCCESS(status)) {
            ...
            PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                          ("NtFreezer!NtFreezerPreOperation: FltRequestOperationStatusCallback Failed, status=%08x\n",
                           status) );
        }
    }
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerOperationStatusCallback: Entered\n") );

    PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                  ("NtFreezer!NtFreezerOperationStatusCallback: Status=%08x ctx=%p IrpMj=%02x.%02x \"%s\"\n",
                   OperationStatus,
                   RequesterContext,
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerPostOperation: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("NtFreezer!NtFreezerPreOperationNoPostOperation: Entered\n") );
